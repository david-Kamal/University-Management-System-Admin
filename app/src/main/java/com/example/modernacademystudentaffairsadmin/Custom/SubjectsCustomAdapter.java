...
public class SubjectsCustomAdapter extends ArrayAdapter<SubjectsData>
{

    private Context context;
    private ArrayList<SubjectsData> values;

    public SubjectsCustomAdapter(@NonNull Context context, int resource, @NonNull ArrayList<SubjectsData> values)
    {
    ...
    @Override
    public SubjectsData getItem(int position){
